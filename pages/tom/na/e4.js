...
import NAE4 from "../../../src/assets/data/NAE4";
...
function EliteFour() {
  return (
    <Container>
      <Head>
        <title>NA Elite Four | PvP HQ</title>
      </Head>
      <GymHero gymName={"Elite Four"} gymLocation={"North America Region"} />
      <BackButton text={"All NA Gyms"} path={"/tom/na"} />
      <TextContainer>
        <h1>
          The <Highlight>Elite Four </Highlight>defending North America Region
          will be :
        </h1>
      </TextContainer>
      {NAE4.map((E4) => (
